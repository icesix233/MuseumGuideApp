...
import com.example.wifilocation997.service.MusicService;
...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("mgoods", String.valueOf(mGoodsId));
        init();
    ...
    private void init(){
        ...
        if (mGoodsId > 0) {
            ...
            name_song.setText(info.exhibit_name);
            iv_music.setImageURI(Uri.parse(info.pic_path));
        }
        ...
        int i=intent1.getIntExtra("position",0);
